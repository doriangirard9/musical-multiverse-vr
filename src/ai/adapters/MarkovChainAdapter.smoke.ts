...
//     npx tsx src/ai/adapters/MarkovChainAdapter.smoke.ts
//
...
// Script Node (tsx) — pas de @types/node dans le projet front : on déclare
// le strict nécessaire de `process` localement.
declare const process: { stdout: { write(s: string): void }; exit(code?: number): void };
