...
export class ToolSystem {
    ...
    static readonly #KINDS: readonly ToolKind[] = [
        POINTER_TOOL_KIND, MAGNET_TOOL_KIND, BRICK_TOOL_KIND, CRANE_TOOL_KIND, BLOB_TOOL_KIND, PARAMETER_TOOL_KIND, PENCIL_TOOL_KIND, MAGIC_TOOL_KIND, FINGER_TOOL_KIND, RAY_TOOL_KIND, TELEPORT_TOOL_KIND,
