...
import { ARCH_TOOL_KIND, FLAIL_TOOL_KIND, FINGER_TOOL_KIND, MAGIC_TOOL_KIND, MAGNET_TOOL_KIND, ToolKind, ToolSlot, PARAMETER_TOOL_KIND, PENCIL_TOOL_KIND, POINTER_TOOL_KIND, RAY_TOOL_KIND, SOFT_WAND_TOOL_KIND, SWORD_TOOL_KIND, TWO_WAND_TOOL_KIND, WAND_TOOL_KIND } from "../../tool"
...
export class ToolSystem {
    ...
    static readonly #KINDS: readonly ToolKind[] = [
        POINTER_TOOL_KIND, MAGNET_TOOL_KIND, PARAMETER_TOOL_KIND, PENCIL_TOOL_KIND, MAGIC_TOOL_KIND, FINGER_TOOL_KIND, RAY_TOOL_KIND,
