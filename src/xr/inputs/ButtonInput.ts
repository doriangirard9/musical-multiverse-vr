...
export class ButtonInput {
    ...
    readonly onChange = new Observable<ButtonInputEvent>()
    
    /** Observable that notifies when the button is pressed down.  */
    readonly onDown = new Observable<ButtonInputEvent>()
    
    /** Observable that notifies when the button is released (up).  */
    readonly onUp = new Observable<ButtonInputEvent>()
    
    /** Observable that notifies when the button is touched.  */
    readonly onTouch = new Observable<ButtonInputEvent>()
    
    /** Observable that notifies when the button stop being touched.  */
    readonly onUntouch = new Observable<ButtonInputEvent>()
